...
//создание именных запросов, выполняемых по переданному параметру
@NamedQueries({
...
@Entity
@Table(name = "users", uniqueConstraints = {@UniqueConstraint(columnNames = "email", name = "users_unique_email_idx")}) //уникальное поле(индекс)
